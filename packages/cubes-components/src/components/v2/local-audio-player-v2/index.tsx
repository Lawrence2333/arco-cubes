...
const AudioLocalPlayer = ({
  ...
  const { audio_url, song_name, creator_name, thumbnail, card_type } = datas;
  ...
  const handlePlayPause = (e: React.MouseEvent) => {
    e.stopPropagation();
    Cubes.Tracker.trackBioViewClick(audio_url, true, contextTrackInfo());
    if (audioRef.current) {
      if (isPlaying) {
...
export default AudioLocalPlayer;
